...
$(document).ready(function () {
    ...
    document.getElementById('name').value = get('name') !== undefined ? get('name') : generateName();
    document.getElementById('colour').value = get('colour') !== undefined ? get('colour') : generateColour();
});